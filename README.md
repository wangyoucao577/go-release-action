...
| release_name           | **Optional**               | Target release name to publish your binaries to. The newest created one gets picked. It's dedicated to publish binaries on every `push` into one specified release page since there's no target in this case. DON'T set it if you trigger the action by `release: [created]` event as most people do.                                                                                                                                                                                                                                                                                                                 |
