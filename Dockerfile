...
RUN wget --no-check-certificate --progress=dot:mega https://github.com/wangyoucao577/assets-uploader/releases/download/v0.6.0/github-assets-uploader-v0.6.0-linux-amd64.tar.gz -O github-assets-uploader.tar.gz && \
